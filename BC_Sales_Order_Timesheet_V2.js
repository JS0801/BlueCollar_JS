  ...
  function buildConsolidatedInvoiceData(tranIds) {
    ...
    for (var c = 0; c < categories.length; c++) {
      ...
      rowsHtml += ''
        ...
        + '<td colspan="2" style="border-right:0px; border-top:0px; border-left:0px; border-bottom:1px solid #C9C9C9; mso-number-format:\\0022$\\0022#,##0.00;-\\0022$\\0022#,##0.00;" align="right">' + money(amt) + '</td>'
